...
When using `gh pr edit` with markdown body, wrap the argument in `$'...'` (ANSI-C quoting) to prevent bash from interpreting backticks as command substitution. E.g.: `gh pr edit 1 --body $'Body with `backticks`'`.
